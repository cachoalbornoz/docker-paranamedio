            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    <h5>
                        Permisos
                        <small>
                            <a href="{{ route('permissions.create') }}" class="btn btn-link">(+) Crear</a>
                        </small>
                    </h5>
                </div>
            </div>
...
@section('js')
    ...
    <script type="module">
        ...
        var table = $('#permission').DataTable({
            ...
            ajax: "{{ route('permissions.getpermission') }}",
            columns: [{
                    data: 'check',
                    class: 'w-5'
                },
        ...
        $('#permission').on("click", ".borrar", function() {
        ...
        $('#permission').on("click", ".checkall", function() {
