...
@section('content')
    ...
    <div class="card">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    <h5>
                        Tipo placas
                        <small>
                            <a href="{{ route('tipoplaca.create') }}" class="btn btn-link">(+) Crear</a>
                        </small>
                    </h5>
                </div>
            </div>
        ...
        <div class="card-body">
            <table class="table table-hover" id="tipoplacas">
                <thead>
                    <tr>
                        <th class="w-5">
...
@section('js')
    ...
    <script type="module">
        ...
        var table = $('#tipoplacas').DataTable({
            lengthMenu: [
                [10, 25, 50],
                [10, 25, 50]
            ],
            ...
            ajax: "{{ route('tipoplaca.getTipoPlaca') }}",
            columns: [
                {
                    data: 'check',
                    class: 'w-5'
        ...
        $('#tipoplacas').on("click", ".borrar", function() {
