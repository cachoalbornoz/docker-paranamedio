...
class ModbusMaster
{
    ...
    /**
     * Converts a float value to two 16-bit Modbus registers.
     *
     * @param  float $floatValue
     * @return array
     */
    
    public function floatToRegisters($floatValue)
    {
        $int32    = unpack('L', pack('f', $floatValue))[1];
        $lowWord  = $int32         & 0xFFFF;
        $highWord = ($int32 >> 16) & 0xFFFF;
