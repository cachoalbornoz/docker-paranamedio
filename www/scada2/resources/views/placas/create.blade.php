        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['route' => 'placas.store', 'enctype' => 'multipart/form-data']) }}
                            ...
                            <div class="form-group">
                                <select name="f_idtipoplaca" class="js-example-basic-single form-control"
                                    ...
                                    @foreach ($tipoplacas as $tipoplaca)
                                        <option value="{{ $tipoplaca->f_idtipoplaca }}">{{ $tipoplaca->f_nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <select name="f_idestacion" class="js-example-basic-single form-control"
                                    ...
                                    @foreach ($estaciones as $estacion)
                                        <option value="{{ $estacion->f_idestacion }}">{{ $estacion->f_nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
